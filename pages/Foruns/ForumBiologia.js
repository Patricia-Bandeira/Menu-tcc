...
export default function ForumBiologia() {
  ...
  const [keyTagPressed, setKeyTagPressed] = useState(41);
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <Text style={styles.textDescription}>
            Biologia é a ciência natural que estuda, descreve, preserva e
            eventualmente explora economicamente a vida e os organismos vivos
          </Text>
