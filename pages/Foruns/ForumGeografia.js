...
export default function ForumGeografia() {
  ...
  const [keyTagPressed, setKeyTagPressed] = useState(75);
    ...
    <View style={Css.container}>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          Geografia é uma área da ciência dedicado ao estudo responsável 
          por examinar a superfície do planeta Terra e compreender todos os aspectos físicos deste.
          </Text>
