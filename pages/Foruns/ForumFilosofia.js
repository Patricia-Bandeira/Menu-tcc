...
export default function ForumFilosofia() {
  ...
  const [keyTagPressed, setKeyTagPressed] = useState(17);
    ...
    <View style={Css.container}>
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          Filosofia é o estudo de questões gerais e fundamentais sobre a existência, 
          conhecimento, valores, razão, mente, e linguagem; frequentemente colocadas como problemas a se resolver.
          </Text>
